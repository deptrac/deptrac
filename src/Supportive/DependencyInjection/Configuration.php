                ...
                ->arrayNode('analyser')
                    ...
                    ->children()
                        ...
                        ->arrayNode('types')
                            ...
                            ->scalarPrototype()
                                ->beforeNormalization()
                                    ->ifTrue(static fn ($type): bool => !is_string($type) || '' === $type)
                                    ->thenInvalid('Invalid type %s, expected a non-empty string: either a default emitter type or the key of a custom dependency emitter')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
