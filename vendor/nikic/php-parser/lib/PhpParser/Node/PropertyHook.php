...
use DEPTRAC_INTERNAL\PhpParser\Modifiers;
use DEPTRAC_INTERNAL\PhpParser\Node\Expr\Assign;
use DEPTRAC_INTERNAL\PhpParser\Node\Expr\PropertyFetch;
use DEPTRAC_INTERNAL\PhpParser\Node\Expr\Variable;
use DEPTRAC_INTERNAL\PhpParser\Node\Stmt\Expression;
use DEPTRAC_INTERNAL\PhpParser\Node\Stmt\Return_;
